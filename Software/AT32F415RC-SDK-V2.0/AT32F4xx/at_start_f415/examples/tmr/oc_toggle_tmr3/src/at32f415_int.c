...
/** @addtogroup 415_TMR_oc_toggle_tmr3
  * @{
  */
...
void TMR3_GLOBAL_IRQHandler(void)
{
  ...
  if(tmr_flag_get(TMR3, TMR_C1_FLAG) != RESET)
  {
    ...
    tmr_channel_value_set(TMR3, TMR_SELECT_CHANNEL_1, capture + ch1_val);
  }
  ...
  if(tmr_flag_get(TMR3, TMR_C2_FLAG) != RESET)
  {
    ...
    tmr_channel_value_set(TMR3, TMR_SELECT_CHANNEL_2, capture + ch2_val);
  }
  ...
  if(tmr_flag_get(TMR3, TMR_C3_FLAG) != RESET)
  {
    ...
    tmr_channel_value_set(TMR3, TMR_SELECT_CHANNEL_3, capture + ch3_val);
  }
  ...
  if(tmr_flag_get(TMR3, TMR_C4_FLAG) != RESET)
  {
    ...
    tmr_channel_value_set(TMR3, TMR_SELECT_CHANNEL_4, capture + ch4_val);
  }
}
